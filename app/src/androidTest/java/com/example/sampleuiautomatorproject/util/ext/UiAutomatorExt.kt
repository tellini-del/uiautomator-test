...
private val defaultTimeout = 100.secondsToMillis()
private val defaultLongTimeout = 1000000000.secondsToMillis()
...
fun BySelector.waitFindObjectForWhile(timeout: Long = defaultLongTimeout): UiObject2 {
    return device.wait(Until.findObject(this), timeout)
}
...
fun BySelector.hasObject(byText: BySelector): Boolean {
